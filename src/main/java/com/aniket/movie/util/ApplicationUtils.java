...
public class ApplicationUtils {
    ...
    public SearchListResponse getSearchedResult(SearchListRequest searchListRequest) {
        ...
        //SearchListResponse result = restTemplate.exchange("http://localhost:"+applicationPort+  "/cache/search", HttpMethod.POST, entity, SearchListResponse.class).getBody();
        SearchListResponse result = restTemplate.exchange(hazelcastServiceUrlBase + "/cache/search", HttpMethod.POST, entity, SearchListResponse.class).getBody();
